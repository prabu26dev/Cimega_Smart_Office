window.ModulSpj = {
  ...
  render: function() {
    this.container.innerHTML = `
      <div class="card" style="border-color:var(--gold);">
        ...
        <div class="card-body">
          <p style="font-size:11px; color:var(--muted); margin-bottom:15px;">Generate kwitansi resmi yang dicetak di kertas A4 tanpa UI sistem yang tampak.</p>
          ...
          <div class="form-group"><label class="form-label">Untuk Pembayaran (Uraian)</label><textarea class="form-control" id="kwiUraian" placeholder="Pembelian Alat Tulis Kantor dan Tinta Printer BOSP..."></textarea></div>
          ...
          <button class="btn btn-success" style="width:100%; justify-content:center; padding:12px; margin-top:10px; font-size:14px;" onclick="window.ModulSpj.generatePrint()">🖨️ Cetak Kwitansi Resmi (PDF)</button>
        </div>
      </div>

      <!-- PRINTABLE SPJ CONTAINER -->
  ...
  generatePrint: function() {
    ...
    if(nominalRaw <= 0) return alert("Massukan nominal wajar!");
    ...
    // Strict Corporate Print Layout Setup
    pr.innerHTML = `
      <div style="border: 2px solid #000; padding: 30px; font-family: 'Times New Roman', Times, serif; color:#000; max-width:800px; margin:0 auto; background:#fff;">
        ...
        <table style="width: 100%; font-size: 16px; margin-bottom:20px; border-spacing:0 15px;">
          <tr>
            <td style="width: 25%; font-weight: bold; vertical-align:top;">Telah Terima Dari</td>
            <td style="width: 3%; vertical-align:top;">:</td>
            <td style="vertical-align:top;">${dr}</td>
          </tr>
          <tr>
            <td style="font-weight: bold; vertical-align:top;">Uang Sebanyak</td>
            <td style="vertical-align:top;">:</td>
            <td style="vertical-align:top; font-style:italic; border:1px dashed #999; padding:10px; background:#f9f9f9;">${terbilangStr}</td>
          </tr>
          <tr>
            <td style="font-weight: bold; vertical-align:top;">Guna Membayar</td>
            <td style="vertical-align:top;">:</td>
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-top: 40px;">
          <div style="border: 2px solid #000; padding: 15px 30px; font-size: 24px; font-weight: bold; background:#f0f0f0;">
            ${rp}
          </div>
